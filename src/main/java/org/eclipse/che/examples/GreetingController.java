...
import org.eclipse.che.examples.dao.impl.ImageDaoImpl;
...
public class GreetingController {
	...
	public ModelAndView uploadPage() {
	    ModelAndView view = new ModelAndView("upload_page");
	    return view;
	}
	
	@RequestMapping(value = "/upload", method = RequestMethod.POST)
	@ResponseBody
	public void upload(MultipartFile file) throws ServerException {
	    Image image = null;
	    try {
	        if (file == null) {
	            throw new ServerException("File is not required");
	        }
